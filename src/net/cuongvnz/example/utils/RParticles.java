...
public class RParticles {
    ...
    public static void sendLightning(Player p, Location loc) {
        ...
        try {
            ...
            if (p != null) {
                sendPacket(p, obj);
                p.playSound(loc, Sound.ENTITY_LIGHTNING_THUNDER, 0.75f, 0.75f);//25, 1
            }
            ...
            for (Entity e : RMath.getNearbyEntities(loc, 25)) {
                if (e instanceof Player) {
                    ...
                    ((Player) e).playSound(loc, Sound.ENTITY_LIGHTNING_THUNDER, 0.75f, 0.75f);
                }
            }
    ...
    public static void showWithColor(ParticleEffect effect, Location loc, Color color) {
        effect.display(loc, color, 1.5);
    }
    ...
    public static void showByTime(ParticleEffect effect, Entity entity, int tick) {
        ...
        }.runTaskTimer(NeoRPGCore.plugin, 0, 1);
    }
